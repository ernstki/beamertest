...
Inline, with a \texttt{data:} URI; shows up in the Beamer slides, but
weirdly sized.
\end{frame}
...
\texttt{.mermaid\ format=svg} hidden from slides in a ``notes'' section,
but shows up in README.

\note{\includegraphics{img/mermaid.svg}}

\centerline{\includegraphics[width=3in]{img/mermaid.pdf}}

Hat tip to Jeromy Anglim for the size/alignment tip using
\texttt{\textbackslash{}includegraphics}\footnote<.->{https://jeromyanglim.blogspot.com/2012/07/beamer-pandoc-markdown.html}
\end{frame}
...
Just a plain old slide.\footnote<.->{Do footnotes work?}
\end{frame}
